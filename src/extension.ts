...
// let autoDocStatusBarItem: vscode.StatusBarItem; // <-- Declare our status bar item variable

// export function activate(context: vscode.ExtensionContext) {
//     console.log('Congratulations, the extension "Auto-Doc" is now active!');

//     // Create and show the status bar item
//     autoDocStatusBarItem = createStatusBarItem();
...
//     context.subscriptions.push(onDidOpen, onDidSave, onDidClose);
// }

// function createStatusBarItem(): vscode.StatusBarItem {
//     // Create the status bar item, aligning it to the left
//     const item = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 100);
    
//     // Set its properties
//     item.text = `$(file-text) Auto-Doc`; // The icon and text
//     item.tooltip = "Auto-Doc is active and logging changes."; // Hover text
//     item.color = '#32CD32'; // A nice lime green color
